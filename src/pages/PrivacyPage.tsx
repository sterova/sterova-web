      ...
      <div className="container-custom max-w-3xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <section>
            ...
            <p>
              {SITE.name} (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to
          ...
          <section>
            ...
            <ul>
              <li>
                <strong>Contact information</strong> — name, email address, company name, and phone number
                when you fill out our contact form.
              </li>
              <li>
                <strong>Project information</strong> — details about your project scope, timeline, and
                budget that you share with us voluntarily.
              </li>
              <li>
                <strong>Usage data</strong> — anonymized analytics data such as pages visited and time
                spent on the site.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              without your consent, except as required by law or necessary to deliver our services
              (e.g., cloud hosting providers under appropriate data processing agreements).
            </p>
          </section>

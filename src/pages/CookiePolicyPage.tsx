          ...
          <div className="prose prose-invert prose-headings:font-display max-w-none">
            <section>
              ...
              <p>
                ...
                help the site remember information about your visit — like your preferences or
                session state — so it works better for you on your next visit.
              </p>
            </section>
            ...
            <section>
              ...
              <ul>
                <li>
                  <strong>Essential cookies</strong> — Required for the site to function. These
                  include session management, CSRF protection, and theme preference. They cannot be
                  turned off.
                </li>
                <li>
                  <strong>Functional cookies</strong> — Remember your preferences (such as
                  dark/light mode) to improve your experience. These persist across sessions.
                </li>
              </ul>
              <p>
                We do <strong>not</strong> use advertising cookies, cross-site tracking cookies, or
                third-party analytics platforms that fingerprint individual users.
              </p>
            </section>
            ...
            <section>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <code>sterova-chat-transcript</code>
                    </td>
            ...
            <section>
              ...
              <p>
                We do not load any third-party scripts that set their own cookies on first page
                load. If you interact with embedded content or external links, those third parties
            ...
            <section>
              ...
              <p>
                ...
                view, delete, and block cookies. Note that disabling essential cookies may affect
                how the site functions.
              </p>
              <p>Useful links for managing cookies in common browsers:</p>
              <ul>
                <li>
                  <a
            ...
            <section>
              ...
              <p>
                We may update this Cookie Policy when we change the cookies we use. Changes will be

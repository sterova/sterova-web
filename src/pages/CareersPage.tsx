...
const WHY = [
  ...
  },
  {
    ...
    description: "Learning budget, conference access, and a culture that rewards curiosity.",
  },
  {
    title: "Ownership",
    description: "Engineers own their domains. We trust people to make good decisions.",
  },
  {
    title: "Impact",
    description:
  ...
  },
  {
    ...
    description: "No political games. Just good people building good software.",
  },
];
      ...
      <section className="section-y bg-surface">
        <div className="container-custom">
          ...
          {OPEN_POSITIONS.length === 0 ? (
            <AnimatedSection className="text-center py-16 card-premium">
            ...
            <div className="space-y-4">
              {OPEN_POSITIONS.map((pos) => (
                <div
                  key={pos.id}
                  className="card-premium p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"
                >
                  <div>

  ...
  return (
    <div className="min-h-screen flex bg-secondary/20">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* We use a React Context to allow pages to set the header, OR we just let pages render their own header. */}
        {/* But we need the onMenuClick prop for the mobile drawer toggle. */}
        {/* Actually, it's easier to just pass the setMobileOpen down via a context or cloneElement, but since we want to keep it simple, we can provide it through a simple React context. */}
...
export const MobileMenuContext = createContext<(() => void) | null>(null);

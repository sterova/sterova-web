          ...
          >
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <Button
                ...
                variant="outline"
                size="xl"
                className="group bg-background/95 backdrop-blur-xl border-foreground/30 dark:border-foreground/40 transition-[transform,background-color,border-color] duration-300 hover:-translate-y-0.5 hover:bg-muted hover:border-foreground/50 focus-visible:-translate-y-0.5 motion-reduce:transition-none"
              >

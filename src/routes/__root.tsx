...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/icons/favicon-16x16.png", type: "image/png", sizes: "16x16" },
      ...
      { rel: "icon", href: "/icons/favicon-96x96.png", type: "image/png", sizes: "96x96" },
      { rel: "icon", href: "/icons/favicon-144x144.png", type: "image/png", sizes: "144x144" },
